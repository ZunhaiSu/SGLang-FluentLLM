...
class MoELayer(torch.nn.Module):
    def __init__(self, top_k, num_experts, hidden_size, intermediate_size, quant_config, layer_index, prefix: str = "", zero_expert_type: str = ""):
        super().__init__()
        ...
        self.executor = GEMMWrapperCls(top_k, num_experts, self, quant_config).get_executor(dispatcher_type, "silu")
